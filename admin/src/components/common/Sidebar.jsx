...
const Sidebar = () => {
  ...
  const menuItems = [
    // 1. TỔNG QUAN (Chỉ hiện cho Role 1, 2, 4)
    {
      path: '/dashboard',
      name: 'Tổng quan',
    ...
    // 2. NHÓM BÁN HÀNG (Đơn hàng & Khách hàng đi cùng nhau)
    {
      path: '/orders',
      name: 'Đơn hàng',
      permission: 'order.view',
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"></path><rect x="9" y="3" width="6" height="4" rx="1"></rect><path d="M9 14l2 2 4-4"></path></svg>
    },
    {
      path: '/customers',
      name: 'Khách hàng',
    ...
    // 3. NHÓM KHO VẬN
    {
      ...
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 7.5L12 3 4 7.5 4 16.5 12 21 20 16.5z"></path><path d="M12 21L12 12"></path><path d="M20 7.5L12 12 4 7.5"></path></svg>
    },
    {
      path: '/inventory',
      name: 'Kho hàng',
      permission: 'inventory.view',
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg>
    },
